...
export const Red = () => {
    ...
    for (let key in red) {
      array.push(
           <Card p='6px' key={key} color='white'  backgroundColor={key}>{key}</Card>
      );
    }
    return array;
  };
